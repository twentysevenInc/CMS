...
<div class="settings-table-title">
	...
	<a href="javascript:void(0);" onclick="javascript:navigateTo('components/settings/manageplugins/install.php', '#settings', undefined)" class="button normal-button">Install Plugin</a>
</div>
...
<?php
$db = new Database;
$result = $db->query("SELECT plugin.name, plugin.author, plugin.version FROM plugin ORDER BY plugin.name");
