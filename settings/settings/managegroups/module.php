...
<div class="settings-table-title">
	...
	<a href="javascript:void(0);" onclick="javascript:navigateTo('settings/settings/managegroups/addGroup.php', '#settings', undefined)" class="button normal-button">New Group</a>
</div>
...
<?php
$db = new Database;
$result = $db->query("SELECT g.name, g.id FROM `cms-group` AS g ORDER BY g.name");
